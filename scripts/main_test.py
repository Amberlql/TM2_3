...
#Import modules
from visualization import ObjectPlotter, create_plane_mesh, ContourPlotter
from centerlinepoints import centerline_straightcylinder
from plane_intersections import intersection_planes_with_objects
from contour_creation import create_contour_from_intersection_points
from line_intersections import filter_planes, line_intersections
from features import calculate_distance, filter_distances, feature_maximum_contact_length, feature_angles
...
maximum_contact_length, plane_numbers_maximum_contact_length = feature_maximum_contact_length(all_distances_filtered, 1.5)
